...
* [Groovy Templates](https://docs.spring.io/spring-boot/4.0.0/reference/web/servlet.html#web.servlet.spring-mvc.template-engines)
* [Spring HATEOAS](https://docs.spring.io/spring-boot/4.0.0/reference/web/spring-hateoas.html)
* [Jersey](https://docs.spring.io/spring-boot/4.0.0/reference/web/servlet.html#web.servlet.jersey)
* [Spring Modulith](https://docs.spring.io/spring-modulith/reference/)
* [Mustache](https://docs.spring.io/spring-boot/4.0.0/reference/web/servlet.html#web.servlet.spring-mvc.template-engines)
...
```
$ docker run --rm -p 8080:8080 Leasing_spring:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/Leasing_spring
```
